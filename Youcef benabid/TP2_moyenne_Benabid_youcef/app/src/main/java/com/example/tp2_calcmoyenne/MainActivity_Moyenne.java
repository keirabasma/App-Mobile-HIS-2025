...
public class MainActivity_Moyenne extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_moyenne);
        ...
        calculerBtn.setOnClickListener(v -> {
            ...
            {
                Toast.makeText(MainActivity_Moyenne.this, "Veuillez remplir tous les champs", Toast.LENGTH_SHORT).show();
            }
            else
            {
                ...
                Intent intent;
                if (moyenne >= 10) {
                    intent = new Intent(MainActivity_Moyenne.this, SuccessActivity.class);
                    intent.putExtra("MOYENNE", moyenne);
                    startActivity(intent);
                } else {
                    intent = new Intent(MainActivity_Moyenne.this, FailActivity.class);
                    intent.putExtra("MOYENNE", moyenne);
                    startActivity(intent);
                }
